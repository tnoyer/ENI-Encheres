...
<body>
	...
	<div class="block-connexion">
		<form method="post" action="${pageContext.request.contextPath}/login">
			<p>
				<label class="label-connexion" for="pseudo">Identifiant: </label> <input
					type="text" name="pseudo" id="pseudo">
			</p>

			<p>
				<label class="label-connexion" for="password">Mot de passe:
			...
			<div class="block-btn-connexion">
				...
				<div class="block-remember">
					<p>
						<input type="checkbox" name="rememberme" id="remembercheckbox" /><label
							for="remembercheckbox">Se souvenir de moi</label>
					</p>
	...
	<div class="block-btn-creation">
		<a class="btn btn-secondary btn-lg active" id="btn-creation"
			href="${pageContext.request.contextPath}/register" role="button">Créer
			un compte</a>
	</div>
